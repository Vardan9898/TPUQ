...
@foreach($tenants as $tenant)
        ...
        <div class="col-xl-3 col-sm-6 mb-5 mt-3">
            <div class="bg-white rounded shadow-sm py-5 px-4"><img src="{{ asset('storage/' . $tenant->image) }}" alt="" width="100" class="img-fluid rounded-circle mb-3 img-thumbnail shadow-sm">
