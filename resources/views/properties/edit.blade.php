<x-layout>
    ...
    <form action="/properties/{{ $property->id }}/edit" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea type="text" class="form-control" id="description" name="description">{{ $property->description }}</textarea>
        </div>
        ...
        <div class="form-check form-switch mb-3">
            <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="mortgage_status" value="1" {{ $property->mortgage_status == '1' ? 'checked' : '' }}>
